...
export default defineConfig({
  ...
  shortcuts: {
    ...
    "branding-link":
      "flex items-center gap-0 border border-solid border-[var(--theme-accent-glow)] bg-[rgba(0,0,0,0.3)] px-1.5 py-0.5 no-underline transition-all duration-300 hover:border-[var(--theme-accent)] max-lg:mx-auto max-lg:w-fit",
    "branding-text":
